...
export default function MemoryRules() {
  return (
    <main style={{ padding: '1rem 0' }}>
      ...
      >
        <p>
          Choose a difficulty level from the list of 8 options. The level is based on the number of cards you would like to handle. For example, if you choose level 1, you will have 4 pairs of cards. If you choose level 2, you will have 6 pairs of cards. The number of cards will increase by 4 for each level. The maximum number of cards is 36. 
        </p>
        <p>
